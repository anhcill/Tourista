...
export default function PartnerHotelCreatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess('Gửi yêu cầu tạo khách sạn thành công. Vui lòng chờ admin duyệt.');
      setTimeout(() => router.push('/partner/hotels'), 2000);
    } catch (err) {
      const msg = err instanceof Error ? err.message : 'Tạo khách sạn thất bại.';
      setError(msg);
    } finally {
      setSubmitting(false);
    }
  ...
  return (
    <section className={styles.page}>
      <div className={styles.hero}>
        ...
        <p>Thông tin cơ bản của khách sạn. Sau khi gửi, admin sẽ xem xét và duyệt.</p>
      </div>

...
const PAYMENT_METHODS = [
  {
    ...
    icon: <FaWallet />,
    title: 'Ví MoMo',
    subtitle: 'Quét QR hoặc xác thực OTP',
    badge: 'Nhanh',
    enabled: true,
  },
  {
    ...
    subtitle: 'Nhập thông tin thẻ để thanh toán',
    badge: 'Ưu tiên',
    enabled: true,
  },
  {
    ...
    subtitle: 'Tạo mã đơn và xác nhận thanh toán thủ công',
    badge: 'Doanh nghiệp',
    enabled: true,
  },
  {
    ...
    icon: <FaMobileAlt />,
    title: 'ZaloPay',
    subtitle: 'Thanh toán ví điện tử nhanh chóng',
    badge: 'Mới',
    enabled: true,
  },
  {
